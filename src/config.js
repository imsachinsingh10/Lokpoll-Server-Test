...
export class Config {
    ...
    static version = {
        majorRevision: 6,  // (new UI, lots of new features, conceptual change, etc.)
        minorRevision: 8,  // (maybe a change to a search box, 1 feature added, collection of bug fixes)
