...
INSERT INTO `user` (`firstName`, `lastName`, `email`, `password`, `roleId`, `workingStatus`, `loginStatus`, `avatarBG`) VALUES ('super', 'admin', 'sa@lokpoll.com', '1234', '1', 'active', 'online', '#4c5264');
